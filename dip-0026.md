...
These rules apply only to owner payout list entries. The operator reward and
operator payout script remain governed by DIP-0003 and are unchanged by this DIP.
